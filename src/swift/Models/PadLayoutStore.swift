...
final class PadLayoutStore: @unchecked Sendable {
    ...
    static let defaultPortrait: [String: PadGroupPosition] = [
        ...
        "dpad":   PadGroupPosition(x: 0.12, y: 0.48, scale: 1.0),
        "action": PadGroupPosition(x: 0.88, y: 0.44, scale: 1.0),
        "lstick": PadGroupPosition(x: 0.28, y: 0.78, scale: 1.0),
        "rstick": PadGroupPosition(x: 0.72, y: 0.78, scale: 1.0),
    ]

    // Landscape: relative to full screen
    static let defaultLandscape: [String: PadGroupPosition] = [
        "dpad":   PadGroupPosition(x: 0.08, y: 0.80, scale: 1.0),
        "action": PadGroupPosition(x: 0.92, y: 0.80, scale: 1.0),
        "l2":     PadGroupPosition(x: 0.08, y: 0.28, scale: 1.0),
        "l1":     PadGroupPosition(x: 0.08, y: 0.36, scale: 1.0),
        "r2":     PadGroupPosition(x: 0.92, y: 0.28, scale: 1.0),
        "r1":     PadGroupPosition(x: 0.92, y: 0.36, scale: 1.0),
        "select": PadGroupPosition(x: 0.43, y: 0.95, scale: 1.0),
        "start":  PadGroupPosition(x: 0.57, y: 0.95, scale: 1.0),
        "lstick": PadGroupPosition(x: 0.20, y: 0.90, scale: 1.0),
        "rstick": PadGroupPosition(x: 0.80, y: 0.90, scale: 1.0),
    ]
